    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Saved Providers</h2>
          {error?.providers ? (
              ...
              {savedProviders.map((provider) => (
                ...
                >
                  ...
                  {provider.specialties && (
                    <div className="text-sm text-gray-600">{provider.specialties.join(', ')}</div>
                  )}
                </li>
              ))}
            </ul>
          ) : (
            <p className="text-gray-500">No saved providers yet. Browse our provider list to find the right match for you.</p>
          )}
        </div>
